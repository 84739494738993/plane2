...
let Colors = {
  ...
  ambientLight = new THREE.AmbientLight(0xFF8844, .100000);
  directionLight = new THREE.DirectionalLight(0xfffffff, .20)
  directionLight.position.set(0, 10, 0);
  directionLight.target.position.set(-115, 0, 0);
...
this.mesh.receiveShadow = true;
  ...
  airplane.mesh.rotation.z = (targetY - airplane.mesh.position.y)*0.0088;
  airplane.mesh.rotation.x = (airplane.mesh.position.y - targetY)*0.014;
  airplane.mesh.position.x += (targetX - airplane.mesh.position.x )*0.02;
  airplane.propeller.rotation.x+=0.001;
  }
